# Salt Extension for Sqs Events

Salt Extension for interacting with Sqs Events
...
The saltext-sqs-events project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-sqs-events.git

# Change to the repo dir
cd saltext-sqs-events
```
...
* Writing blog posts
* Sharing your experiences using Salt + Sqs Events
  on social media
...
[issues]: https://github.com/salt-extensions/saltext-sqs-events/issues
[PRs]: https://github.com/salt-extensions/saltext-sqs-events/pulls
[discussions]: https://github.com/salt-extensions/saltext-sqs-events/discussions
[comments]: https://conventionalcomments.org/
[docs]: https://salt-extensions.github.io/saltext-sqs-events/
